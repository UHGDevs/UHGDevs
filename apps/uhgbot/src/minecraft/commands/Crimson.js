module.exports = {
    ...
    run: async (uhg, pmsg) => {
        try {
            ...
            let mcMessage = `Crimson: [${uhg.f(profil.skills.combat.level)}] **${api.username}** ${profil.name} - ${uhg.f(profil.crimson.rep)} Rep |  ${uhg.f(profil.crimson.kuudras)} Kuudras killed | ${uhg.f(profil.crimson.dojo)} Dojo Pts | ${uhg.f(profil.crimson.trophies)} Trophy Fish | ${uhg.capitalize(profil.crimson.fraction)} Faction`
            return mcMessage;
        } catch (e) {
