module.exports = {
    ...
    run: async (uhg, pmsg) => {
        try {
            ...
            const events = api.hypixel.seasonal.events.halloween || {};
            ...
            let mcMessage = `**${year} HalloweenEvent**: **${api.username}** - Level ${Math.floor(data.level)} | ${uhg.f(data.xpleft)} XP do dalšího Levelu | ${uhg.f(api.hypixel.seasonal.silver)} Silver`;
