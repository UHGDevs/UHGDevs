...
module.exports = (hypixel) => {
    ...
    return ({
      ...
      losses: (blitz.games_played || 0)-(blitz.wins || 0)+(blitz.wins_teams || 0),
      wlr: ratio((blitz.wins || 0)+(blitz.wins_teams || 0), (blitz.games_played || 0)-(blitz.wins || 0)+(blitz.wins_teams || 0)),
