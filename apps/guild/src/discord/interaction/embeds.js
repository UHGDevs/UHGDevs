...
module.exports = async (uhg, interaction) => {
  ...
  else if (type == 'events') embed = { title: "**UHG Eventy**", description: "Většinou jde o turnaje v různých minihrách, vše se oznamuje v <#715989905532256346>, zároveň pořádáme celoměsíční soutěž o největší počet GEXP o rank upgrade (jen VIP, VIP+, nebo MVP++) nebo o 200mil Skyblock coinů." }
