...
module.exports = async (uhg, interaction) => {
  ...
  else if (type == 'bot') embed = { title: "**Guild Bot (UHGuild)**", description: "Hypixel a Discord bot <@950076450478899270> / UHGuild)\n➙ Discord-Hypixel chat bridge (propojení mc a dc chatu)\n➙ Stats commands (!sw, !bw, ...) - fungují jak na hypixelu, tak na discordu\n➙ Badges / stats role na discordu\n➙ CZSK Hypixel leaderboard" }
