...
module.exports = async (uhg, interaction) => {
  ...
  else if (type == 'reactionrole') embed = new MessageEmbed().setTitle("**Reaction Role**").setDescription("<:dot:1003711491196854393>**Ping Role**\n<:discord:1003709661335277569> ➜ <@&1003713161238679652>\n<:saturn:1012080877242687500> ➜ <@&1003713511710543952>\n<:games:1003709662941675541> ➜ <@&1003713647845052466>\n\n<:dot:1003711491196854393>**Discord Přehlednost**\n<@&973611610730004510> ➜ Filmový kroužek kanán\n<@&973611610730004510> ➜ Economy kanály")//.setFooter({ text: 'not woking yet' })
