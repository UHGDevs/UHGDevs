...
module.exports = async (uhg, message) => {
  ...
  if (socket._host !== 'mc.hypixel.net') return uhg.settings.offline ? message.reply({ content: "Bot není na hypixelu.", failIfNotExists: false }) : false
  console.log(uhg.mc.client)
